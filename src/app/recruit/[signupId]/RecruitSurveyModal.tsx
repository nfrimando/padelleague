...
export default function RecruitSurveyModal({
  onClose,
  signupId,
  applicant,
  onCompleted,
  ...
  const post = useCallback(
    async (payload: Record<string, unknown>) => {
      ...
      const res = await fetch(`/api/recruit/${signupId}/referrers/me/survey`, {
        method: "POST",
            ...
            <div className="space-y-5">
              ...
              <div className="relative flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-3">
                <div className="flex flex-col items-center gap-2 text-center">
                  <Avatar player={applicant} ring="border-[#00C8DC]/60" />
                  <div>
                    <p className="text-sm font-bold text-white leading-tight">{applicant.name ?? "Applicant"}</p>
              ...
              <div className="relative space-y-2">
                <p className="text-sm text-white/80 text-center leading-relaxed">
                  ...
                  <strong>{applicant.name ?? "they"}</strong> is…
                </p>
            ...
            <div className="space-y-4">
              <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-xl px-4 py-4 text-center space-y-1">
                ...
                <p className="text-xs text-white/70 leading-relaxed">
                  ...
                  {phase.recap.total > 0 && (
                    <>
                      {" "}You rated {applicant.name ?? "them"} better than{" "}
                ...
                <p className="text-[11px] text-[#687FA3] leading-relaxed">
                  Organizers combine everyone&apos;s comparisons — the resulting rating stays hidden from raters.
                </p>
              </div>
              <button
                type="button"
