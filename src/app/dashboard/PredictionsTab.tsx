  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-[#0d1520] border border-[#687FA3]/10 sm:rounded-2xl p-5">
          <p className="text-[10px] font-black uppercase tracking-widest text-[#687FA3] mb-1">
            Total Points
          </p>
          {loading ? (
            <div className="h-7 w-20 bg-[#1a2540] rounded-lg animate-pulse mt-1" />
          ) : (
